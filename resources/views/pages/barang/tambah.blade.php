    ...
    <div class="flex justify-between items-center text-white bg-[#414141] p-2 md:p-4 rounded-lg my-4">
        <form action="" class="w-full flex flex-col gap-4">
            ...
            <label class="flex flex-col w-full">
                ...
                <input type="text" name="jumlah_barang" inputmode="numeric" class="border-2 border-[#d1d1d1] md:px-4 p-2 w-full outline-none rounded-[5px] text-black">
            </label>
            <label class="flex flex-col w-full">
                <span>Tanggal Masuk</span>
                <input type="datetime-local"  name="jumlah_barang" class="border-2 border-[#d1d1d1] md:px-4 p-2 w-full outline-none rounded-[5px] text-black">
            </label>
